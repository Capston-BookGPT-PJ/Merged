...
public class SearchHashtagAdapter extends RecyclerView.Adapter<SearchHashtagAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public SearchHashtagAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchHashtagAdapter.ViewHolder holder, int position) {
