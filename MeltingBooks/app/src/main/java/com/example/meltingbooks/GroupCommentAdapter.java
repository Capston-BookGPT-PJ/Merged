...
public class GroupCommentAdapter extends RecyclerView.Adapter<GroupCommentAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public GroupCommentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.group_comment_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GroupCommentAdapter.ViewHolder holder, int position) {
